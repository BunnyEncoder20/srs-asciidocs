...
// image::assets/lms_content_architecture.png[LMS Content Architecture, 400, align="center"]
...
// image::assets/lms_content_dataflow.png[LMS Content Data Flow, 300, align="center"]
