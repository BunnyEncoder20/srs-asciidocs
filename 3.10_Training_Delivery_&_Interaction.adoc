...
// image::assets/lms_training_architecture.png[LMS Training Architecture, 400, align="center"]
...
// image::assets/lms_training_dataflow.png[LMS Training Data Flow, 300, align="center"]
