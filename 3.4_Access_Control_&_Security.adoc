...
// image::assets/access_security_architecture.png[Security Architecture, 400, align="center"]
...
// image::assets/security_dataflow.png[Security Data Flow, 300, align="center"]
