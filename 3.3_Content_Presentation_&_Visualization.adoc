...
// image::assets/visualization_architecture.png[Visualization Architecture, 400, align="center"]
...
// image::assets/visualization_dataflow.png[Visualization Data Flow, 300, align="center"]
